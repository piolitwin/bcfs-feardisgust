---
title: <font size="5">**Homeostatic relevance promotes access to visual awareness - Disgust**</font> 
...
setwd("C:/Users/pioli/Desktop/Preludium/data/Disgust") 
...
write.csv(subset(locaccoutput, !ID%in%outliersloc), "C:\\Users\\pioli\\Desktop\\Preludium\\Data\\Disgustloc.csv", 
          row.names=FALSE)
...
write.csv(subset(idaccoutput, !ID%in%outliersid), "C:\\Users\\pioli\\Desktop\\Preludium\\Data\\Disgustid.csv", 
          row.names=FALSE)
...
# Working directory - remember to set your own wd path
setwd("C:/Users/pioli/Desktop/Preludium/data/Disgust/SCR")
